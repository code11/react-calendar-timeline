...
export default class Sidebar extends Component {
	...
	shouldComponentUpdate( nextProps, nextState ) {
		...
		return !( arraysEqual( nextProps.groups, this.props.groups ) && nextProps.keys === this.props.keys && nextProps.width === this.props.width && nextProps.lineHeight === this.props.lineHeight && nextProps.fixedHeader === this.props.fixedHeader && nextProps.zIndex === this.props.zIndex && nextProps.groupHeights === this.props.groupHeights && nextProps.height === this.props.height )
	}
	...
	setComponentTop( ) {
		...
		this.setState({ componentTop: viewportOffset.top })
	}
